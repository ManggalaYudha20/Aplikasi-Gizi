...
void main() {
  group('Unit Test: Akurasi Z-Score IMT/U (5-18 Tahun)', () {
    ...
    test('Laki-laki, 5 Tahun 1 Bulan - Gizi Baik', () {
      ...
      final result = NutritionCalculatorService.calculateIMTU5To18(
        ageYears: 5, 
    ...
    test('Kembalikan error jika data referensi usia di luar rentang (misal 4 tahun)', () {
      ...
      // Pesan error disesuaikan dengan yang ada di service terbaru
      expect(result.category, 'Data referensi tidak tersedia untuk usia ini'); 
    });
  });
}