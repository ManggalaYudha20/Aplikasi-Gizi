...
class PdfGenerator {
      ...
      pw.Page(
        build: (pw.Context context) {
          return pw.Column(
            ...
            children: [
              // Header
              pw.Text('RUMAH SAKIT UMUM DAERAH ODSK', style: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 14)),
              pw.Text('Provinsi Sulawesi Utara', style: pw.TextStyle(fontSize: 12)),
              ...
              pw.Center(
                child: pw.Text(
                  'FORMULIR SKRINING GIZI LANJUT UNTUK PASIEN DEWASA',
  ...
  static pw.Widget _buildInfoRow(String label1, String value1, [String? label2, String? value2]) {
    return pw.Row(
      children: [
        pw.Expanded(flex: 2, child: pw.Text(label1)),
        pw.Expanded(flex: 5, child: pw.Text(value1)),
