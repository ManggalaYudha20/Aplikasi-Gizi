...
class _IMTUFormPageState extends State<IMTUFormPage> {
  ...
  void _calculateIMTU() {
    ...
    if (_genderController.text.isEmpty) {
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(const SnackBar(content: Text(_Str.snackNoGender)));
      return;
    }
    ...
    if (totalMonths < 60 || totalMonths > 216) {
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(const SnackBar(content: Text(_Str.snackAgeRange)));
      return;
    }
                ...
                children: [
                  ...
                  if (_result != null) ...[
                    ...
                    ZScoreResultCard(
                      ...
                      additionalInfo:
                          'IMT: ${_result!.bmi.toStringAsFixed(2)} kg/m\u00B2',
                      semanticsLabel:
  ...
  Widget _buildReferenceFormula(double sw) {
    ...
    final zscoreFormula = ReferenceData.formulas.firstWhere(
