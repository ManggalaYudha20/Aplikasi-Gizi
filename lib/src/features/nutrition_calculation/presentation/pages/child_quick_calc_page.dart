          ...
          Padding(
            ...
            child: Column(
              children: [
                ...
                _buildResultRow(
                  'BMR (Schofield)',
                  '${result.bmrSchofield.toStringAsFixed(1)} kkal/hari',
                ),
                const Divider(height: 8),
                _buildResultRow(
                  'Total Energi (TDEE)',
                  '${result.tdee.toStringAsFixed(1)} kkal/hari',
                  isHighlight: true,
                  color: color,
                ),
                const Divider(height: 8),
                _buildResultRow(
                  'Protein',
                  '${result.protein.toStringAsFixed(1)} g/hari',
                ),
                const Divider(height: 8),
                _buildResultRow(
                  'Lemak',
                  '${result.lemak.toStringAsFixed(1)} g/hari',
                ),
                const Divider(height: 8),
                _buildResultRow(
                  'Karbohidrat',
                  '${result.karbo.toStringAsFixed(1)} g/hari',
                ),
                const Divider(height: 8),
                _buildResultRow(
                  'Kebutuhan Cairan',
                  '${result.cairan.toStringAsFixed(1)} ml/hari',
                  isHighlight: true,
