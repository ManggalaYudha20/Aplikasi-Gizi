...
class NutritionStatusData {
  // BB/U (Weight-for-Age) - Boys 0-60 months
  // Z-scores order: [-3 SD, -2 SD, -1 SD, Median, +1 SD, +2 SD, +3 SD]
  static final Map<int, List<double>> bbUBoys = {
  ...
  // BB/U (Weight-for-Age) - Girls 0-60 months
  static final Map<int, List<double>> bbUGirls = {
  ...
  // PB/U or TB/U (Length/Height-for-Age) - Boys 0-60 months
  static final Map<int, List<double>> pbTbUBoys = {
  ...
  // PB/U or TB/U (Length/Height-for-Age) - Girls 0-60 months
  static final Map<int, List<double>> pbTbUGirls = {
  ...
  // IMT/U (BMI-for-Age) - Boys 0-60 months
  static final Map<int, List<double>> imtUBoys = {
    ...
    25: [12.8, 13.8, 14.8, 16.0, 17.3, 18.8, 20.6],
  ...
  // IMT/U (BMI-for-Age) - Girls 0-60 months
  static final Map<int, List<double>> imtUGirls = {
  ...
  // IMT/U (BMI-for-Age) - Boys 5-18 years
  // '5-1' berarti 5 tahun 1 bulan dan seterusnya
  static final Map<String, List<double>> imtUBoys5To18 = {
  ...
  // IMT/U (BMI-for-Age) - Girls 5-18 years
  // '5-1' berarti 5 tahun 1 bulan dan seterusnya
  static final Map<String, List<double>> imtUGirls5To18 = {
  ...
  // BB/PB or BB/TB (Weight-for-Length/Height) - Boys 0-24 months
  static final Map<double, List<double>> bbPbBoys0To24 = {
  ...
  // Standar Berat Badan menurut Tinggi Badan (BB/TB) Anak Laki-Laki 24-60 Bulan
  static final Map<double, List<double>> bbTbBoys24To60 = {
  ...
  // BB/PB or BB/TB (Weight-for-Length/Height) - Girls 0-24 months
  static final Map<double, List<double>> bbPbGirls0To24 = {
  ...
  // Standar Berat Badan menurut Tinggi Badan (BB/TB) Anak Perempuan 24-60 Bulan
  static final Map<double, List<double>> bbTbGirls24To60 = {
