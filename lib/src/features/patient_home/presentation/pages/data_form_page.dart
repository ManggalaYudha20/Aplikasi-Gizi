...
import 'package:aplikasi_diagnosa_gizi/src/features/expert_system/services/expert_system_service.dart';
import 'package:aplikasi_diagnosa_gizi/src/features/expert_system/data/models/diagnosis_terminology.dart';
import 'package:aplikasi_diagnosa_gizi/src/features/expert_system/data/models/intervensi_data.dart';
import 'package:aplikasi_diagnosa_gizi/src/features/expert_system/data/models/monitoring_data.dart';
import 'package:aplikasi_diagnosa_gizi/src/shared/widgets/searchable_terminology_field.dart';
import 'package:aplikasi_diagnosa_gizi/src/features/expert_system/data/models/terminology_item.dart';
...
class _DataFormPageState extends State<DataFormPage> {
  ...
  void _addMonevLabItem(String? type, String value) {
    ...
    if (_monevLabItems.length >= 6) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Maksimal 6 Hasil Lab Terukur'),
  ...
  void _initializeFormWithPatientData() {
    ...
    _parseTD(
      patient.klinikTD,
    ); // Memecah data database ke form sistolik/diastolik
    ...
    if (fullMonevData.contains('Hasil Lab:') ||
      ...
      // 2. Ambil bagian Hasil Terukur
      if (fullMonevData.contains('Hasil Lab:')) {
        // Ambil teks ANTARA 'Hasil Terukur:' dan 'Catatan Tambahan:' (jika ada)
        ...
        for (String line in lines) {
          ...
          if (line.startsWith('-')) {
            ...
            if (colonIndex != -1) {
              ...
              String cleanVal = valWithUnit.split(' ')[0];
      ...
      // FORMAT LAMA / INPUT MANUAL BIASA
      // Masukkan semuanya ke catatan tambahan
      _monevHasilLabController.text = fullMonevData;
    }

    // Jika list kosong setelah parsing, tambahkan 1 item kosong default
    if (_monevLabItems.isEmpty) {
      _addMonevLabItem(null, '');
    }
    ...
    if (FormValidatorUtils.validateAndScroll(
      ...
      try {
        ...
        final patientData = {
          ...
          'monevHasilLab': finalMonevLabString,
