...
class DiabetesCalculationPage extends StatefulWidget {
  ...
  @override
  State<DiabetesCalculationPage> createState() => _DiabetesCalculationPageState();
}
  ...
  void _calculateDiabetesNutrition() {
    if (_formKey.currentState!.validate()) {
      ...
      if (_bloodSugar == 'Tidak terkendali') {
        _totalCalories = _totalCalories! * 0.9; // Reduce 10% for uncontrolled diabetes
      }
      
      if (_bloodPressure == 'Tinggi') {
        _totalCalories = _totalCalories! * 0.95; // Reduce 5% for high blood pressure
      }
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              // Results
              if (_bbIdeal != null && _bmr != null && _totalCalories != null) ...[
                Container(
                    ...
                    children: [
                      ...
                      if (_weightCorrection != null && _weightCorrection! != 0) ...[
                        Text(
                          ...
                          style: TextStyle(
                            fontSize: 16,
                            color: _weightCorrection! > 0 ? Colors.green : Colors.red,
                          ),
                        ),
                      ],
                      if (_hospitalizedStatus == 'Ya') ...[
