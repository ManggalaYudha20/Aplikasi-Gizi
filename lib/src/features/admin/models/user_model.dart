// D:\flutter sdk\aplikasi_diagnosa_gizi\lib\src\features\admin\models\user_model.dart
...
extension UserRoleExtension on UserRole {
  String get label {
    switch (this) {
      ...
      case UserRole.ahliGizi:
        return 'Nutrisionis'; // Data lama juga ditampilkan sebagai Nutrisionis
      case UserRole.nutrisionis:
        return 'Nutrisionis';
      case UserRole.tamu:
        return 'Tamu';
      default:
  ...
  Color get color {
    switch (this) {
      ...
      case UserRole.ahliGizi:
      case UserRole.nutrisionis:
        return Colors.green; // Berlaku untuk keduanya
      case UserRole.tamu:
        return Colors.grey;
      default:
        return Colors.black;
  ...
  String get toFirestoreValue {
    switch (this) {
      case UserRole.admin:
        return 'admin';
      case UserRole.ahliGizi:
        return 'ahli_gizi'; // Biarkan data lama tersimpan apa adanya
      case UserRole.nutrisionis:
        return 'nutrisionis'; // Format baru
      case UserRole.tamu:
        return 'tamu';
      default:
        return 'tamu';
  ...
  static UserRole fromString(String? value) {
    switch (value?.toLowerCase()) {
      ...
      case 'ahli_gizi':
      case 'ahligizi':
        return UserRole.ahliGizi; // Membaca data lama
      case 'nutrisionis':
        return UserRole.nutrisionis; // Membaca data baru
      case 'tamu':
        return UserRole.tamu;
      default:
        return UserRole.tamu; // Default fallback
    }
  }
